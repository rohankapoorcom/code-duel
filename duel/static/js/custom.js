...
function processLoginForm() {
	...
	posting.done(function(data) {
		data = JSON.parse(data);
		if (data['success']) {
			alert = '<div class="alert alert-success alert-dismissable fade in" role="alert"><button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>Thanks for logging in.</div>';
			$form.trigger('reset');
		}
